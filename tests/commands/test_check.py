...
"""
    ...
    for l in result.output.split("\n"):
        ...
        elif "--analysis-mode=4" in l and "pvs-studio" in l.lower() and "--fix" not in l:
...
"""
    code = """// This is an open source non-commercial project. Dear PVS-Studio, please check it.
